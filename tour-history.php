...
<html>
<head>
<title>Tour Bangla | Tourism Management System</title>
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Your Tour History</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
...
<td>#Book ID.<?php echo htmlentities($result->bookid);?></td>
